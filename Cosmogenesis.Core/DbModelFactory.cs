...
public static class DbModelFactory
{
    ...
    public static CreateResult<T> CreateCreateResult<T>(DbConflictType conflict) where T : DbDoc => new(conflict: conflict);
    public static CreateResult<T> CreateCreateResult<T>(T document) where T : DbDoc => new(document: document);
    public static ReplaceResult<T> CreateReplaceResult<T>(DbConflictType conflict) where T : DbDoc => new(conflict: conflict);
    public static ReplaceResult<T> CreateReplaceResult<T>(T document) where T : DbDoc => new(document: document);
    public static CreateOrReplaceResult<T> CreateCreateOrReplaceResult<T>(T document, bool alreadyExisted) where T : DbDoc => new(document: document, alreadyExisted: alreadyExisted);
    public static ReadOrCreateResult<T> CreateReadOrCreateResult<T>(T document, bool alreadyExisted) where T : DbDoc => new(document: document, alreadyExisted: alreadyExisted);
