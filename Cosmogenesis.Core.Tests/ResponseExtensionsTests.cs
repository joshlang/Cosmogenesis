...
namespace Cosmogenesis.Core.Tests
{
    ...
    {
        readonly Mock<ResponseMessage> MockResponseMessage = new Mock<ResponseMessage>(MockBehavior.Strict);
        readonly Mock<TransactionalBatchResponse> MockTransactionalBatchResponse = new Mock<TransactionalBatchResponse>(MockBehavior.Strict);
