...
namespace Cosmogenesis.Core.Tests
{
    public class DbSerializerBaseTests
    {
        ...
        public class NullSerializer : DbSerializerBase
        {
            ...
            [Fact]
            [Trait("Type", "Unit")]
            public void SerializeOptions_DoesNotIgnoreNullValues() => Assert.False(SerializeOptions.IgnoreNullValues);

            [Fact]
            [Trait("Type", "Unit")]
            public void DeserializeOptions_IgnoresNullValues() => Assert.True(DeserializeOptions.IgnoreNullValues);
            ...
            {
                var s = ToStream(new { documents = new object[0] });
                Assert.Throws<NotSupportedException>(() => DeserializeDocumentList<int>(s));
            }
            ...
            {
                var s = ToStream(new { Documents = new int[0] });
